...
A solution is required that will produce summarised and paraphrased reviews on a number of key health topics.  It is envisaged that the reviews will be presented via a short video or infographic through social media.  The process will need to be automated where possible with limited manual intervention or re-write.  

Following the launch of HillsHealth.org in 2012, this project will automate what was previously a manual solution, and deliver the summaries in a contemporary and salient manner.
...
|---|---|---|
|BOJ01 |	Process Optimisation |	Automate the summarisation and paraphrasing of medical papers from scientific journals|
...
Scope -  The project needs to automate the summarisation and paraphrasing of medical papers, and present the output via an online graphic.
...
|Data Wrangling | Transform the medical papers to a summarised and paraphrased review. Reviews should be a handful of key points covering participants, study and results.|
...
Process Map of the proposed solution can be found below:

_...process or data flow map to be included here_

#### Customer Segment
|Customer Segment| Description of Impact|
|---|---|
|All|The output should be universally available via social media and will cover the following key health topics; Diet & Nutrition, Sports & Exercice, Cardiovascular & Stroke, Complementary Medicine, Diabetes, Cancer & Oncology, Pregnanacy & Paediatrics, Elderly and Rheumatology, Dating and Happiness.|
...
|---|---|---|---|---|
|FR01|	Data Mining| Data Mine relevant articles from a selection of medical journals.  The chosen journals will be based on their impact factor, with papers chosen from the range of key health topics as descibed above, and validated against the Jadad criteria.|	M|	UC-01|
|FR02|	Article analysis and refinement|	A solution will summarise and paraphrase the articles provided in FR01.|	M|	UC-|
|FR03|	Create Summary Visualisation|	A solution that will enable the summary created in FR02 to be visualised|	M|	UC-|
|FR04|	Post summaries on-line|	The FR03 output will be posted to social media and other on-line outlets that are relevant to the chosen topic.|	M|	UC-|
