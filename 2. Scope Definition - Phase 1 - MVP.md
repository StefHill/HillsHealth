...
This project will look to enhance the on-line experience by giving users access to evidence-based medicine and health information that is both summarised and paraphrased.  The solution will engage the user via social-media and provide the summaries via short on-line videos or infographics.  Output is expected to be automated with limited manual review.  This will allow for a greater volume of articles that is currently possible via the current HillsHealth.org site.
...
|BOJ03 |	Content Production | Present summaries in a contemporary, clear, and eye-catching manner|
|BOJ04 |	Content Delivery| Use social media to deliver summaries to the wider audience| 
...
![Draft overview](https://user-images.githubusercontent.com/45914355/82380540-86d5a200-9a20-11ea-80f9-67753c8a0645.png)
