...
Scope -  The project needs to automate the summarisation and paraphrasing of medical papers, and present the output online via a graphic.
...
|---|---|
|All|The briefs will be universally available via social media and will cover the following key health topics; Diet & Nutrition, Sports & Exercice, Cardiovascular & Stroke, Complementary Medicine, Diabetes, Cancer, Pregnanacy & Paediatrics, Elderly and Rheumatology, Dating and Happiness.|

#### Out of Scope
Prescription data, population health statistics, and helth spending as a reflection of evidence-based medicine (i.e. the summarised reviews) will be considered as part of phase 2.
...
|FR02|	Article analysis and refinement|	A solution that will summarise and paraphrase the articles as provided in FR01.|	M|	UC-|
