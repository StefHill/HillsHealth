...
<img src="https://user-images.githubusercontent.com/45914355/87730072-b275ce00-c7be-11ea-954e-f1146c5b54ca.png" width="450" height="450">
...
<img src="https://user-images.githubusercontent.com/45914355/82125670-5b905000-979f-11ea-80f1-6ce00096a2ac.png" width="300" height="300">
...
<img src="https://user-images.githubusercontent.com/45914355/117441542-710d0580-af2d-11eb-9082-a681ffa765bd.png" width="300" height="300">
...
![Primary actors](https://user-images.githubusercontent.com/45914355/82615061-57aa6680-9bc1-11ea-9314-b15c51ac02f9.png)

<img src="https://user-images.githubusercontent.com/45914355/82615061-57aa6680-9bc1-11ea-9314-b15c51ac02f9.png" width="300" height="300">
...
The output of the meta-analysis/systematic review will be analysed and a abstractive summary produced.  This will be a system generated abstract and will cover; a) participants, b) study, c) results, d) conclusion.
#### 3. Video output
The results of the abtractive summary will be the basis for a succinct video which will be posted to social media.
...
![MissionStatement](https://user-images.githubusercontent.com/45914355/87787816-2900e300-c834-11ea-9158-904cc66d89bf.png)
...
G1: Create abstractive summaries of Evidence-Based Medicine (EBM) for key health topics.

G2: Compare the latest EBM findings with current U.K GP prescription data.

G3: Compare the latest EBM findings with current U.K. health spending.

G4: Compare the latest EBM findings with current U.K. health population statistics.

G5: Display the output via social-media and the HillsHealth.org web Front End (WFE).

G6: Consider 'narrative' evidence through case studies (personal data) from doctors and patients.
...
![Goal Driver Relationship](https://user-images.githubusercontent.com/45914355/87732680-99bce680-c7c5-11ea-88cf-fea52a00be60.png)

#### Out of Scope

Time is not a factor for this project.  The project is a personal endeavour that will build on the foundations of a CS and Statistics degree with an emphasis on data.
...
![ScopeModelling](https://user-images.githubusercontent.com/45914355/87785938-fdc8c480-c830-11ea-9d59-5b3cfbfacb03.png)
