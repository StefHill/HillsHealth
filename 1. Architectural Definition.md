...
![ProblemDefinition3 (2)](https://user-images.githubusercontent.com/45914355/82125670-5b905000-979f-11ea-80f1-6ce00096a2ac.png)

<img src="https://user-images.githubusercontent.com/45914355/82125670-5b905000-979f-11ea-80f1-6ce00096a2ac.png" width="500" height="500">
...
![TOGAF1](https://user-images.githubusercontent.com/45914355/117441542-710d0580-af2d-11eb-9082-a681ffa765bd.png)

<img src="https://user-images.githubusercontent.com/45914355/117441542-710d0580-af2d-11eb-9082-a681ffa765bd.png" width="500" height="500">

### 1. Preliminary
#### Objectives
Determine capability required - parts of business affected, existing processes or frameworks, what the end delivery will look like.
Establish capability - who are the key stakeholders, what processes/resources are required, what tools/documents will support the process, are the any principles that should be followed (provide link).
Approach - identify the key drivers for this piece, is there a framework we need to follow?

Output… consider
Define the project - sponsor, resources etc
Identify key drivers and resources - understand commercials, culture, current change management, baseline landscape.
Define requirement for work - business requirements, cultural aspirations, strategic intent.
Define principles/framework - what will inform how this work is carried out (Agile/lean), what are the operational management methods (how run BAU Ops), how business systems developed.
Evaluate maturity - what is the definition of done (provide link).

#### Primary Actors
The stakeholder onion diagram is not required at this time, but is included below for future consideration (if required).

![Stakeholder Onion Diagram](https://user-images.githubusercontent.com/45914355/87788875-07a0f680-c836-11ea-9ab4-c85db0509c8a.png)

<img src="https://user-images.githubusercontent.com/45914355/87788875-07a0f680-c836-11ea-9ab4-c85db0509c8a.png" width="500" height="500">
...
<img src="https://user-images.githubusercontent.com/45914355/82615061-57aa6680-9bc1-11ea-9314-b15c51ac02f9.png" width="500" height="500">

#### Capability and Approach


### 2. Architecture Vision (Business Outcome)
Creating a Vision… consider
